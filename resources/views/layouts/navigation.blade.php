    ...
    <div class="px-8">
        <div class="flex justify-between h-14">
            <div class="flex w-[60%] items-center justify-between">
                ...
                <div class="w-[75%]">
                    <form action = "{{ route('dashboard') }}" class="flex items-center">
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" name = "search" id="simple-search" class="bg-gray-100 text-gray-600 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  " placeholder="Search in Drive" value = "{{ request('search') }}">

                            <button class="flex absolute inset-y-0 right-0 items-center pr-3 pointer-events-none">
